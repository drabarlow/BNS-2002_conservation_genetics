...
```{r, out.width = "25%", fig.width = 2, fig.height = 2, dpi = 600, echo = FALSE, fig.cap=""}

my.tree <- read.tree(text="((human,chimp),cat);")
par(mar=c(1,1,1,1))
plot(my.tree)
```
...
```{r, out.width = "87%", dpi = 300, echo = FALSE, fig.align='center', fig.cap=""}
...
```{r, out.width = "70%", fig.width = 4, fig.height = 3.5, dpi = 600, fig.align = "center", echo = FALSE, fig.cap=""}
...
```{r, out.width = "100%", fig.width = 12, fig.height = 1.7, dpi = 600, fig.align = "center", echo = FALSE, fig.cap=""}
...
```{r, out.width = "100%", dpi = 300, echo = FALSE, fig.align = "center", fig.cap=""}
  include_graphics("./assets/img/adder.svg")
```
